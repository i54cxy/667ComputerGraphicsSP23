...
static int PatchIndices[32][4][4]=  {
...
public:
  ...
  */
  MeshTeapot(int level, const int position_loc, const int normal_loc, const int tex_coord_loc) {
    subdivision_count = level;
